...
public class MainCharacterControl implements Serializable {
    ...
    /***
     * This function takes an amount of weeks and converts it into the amount
     * of money a child in the game earns over that many weeks. Because this is
     * not the same gold as the gold the player has, it's okay for it to be 
